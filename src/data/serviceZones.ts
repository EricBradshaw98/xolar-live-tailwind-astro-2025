...
export const serviceZones: ServiceZone[] = [
  {
    ...
    color: '#10B981',
    description: 'Our largest service area covering the GTA with full residential and commercial solar services.'
  },
  {
    id: 'on-ottawa',
    name: 'Ottawa Region',
    ...
    color: '#10B981',
    description: 'Serving Canada\'s capital region with premium solar installations and battery storage.'
  },
  {
    id: 'on-hamilton',
  ...
  },
  {
    ...
    color: '#F59E0B',
    description: 'Expanding our services across southwestern Ontario with new installations weekly.'
  },
  {
    id: 'bc-vancouver',
    ...
    color: '#10B981',
    description: 'Comprehensive solar services for the Lower Mainland with focus on rain-optimized systems.'
  },
  {
    id: 'bc-victoria',
  ...
  },
  {
    ...
    color: '#F59E0B',
    description: 'Expanding services in the historic capital with heritage-sensitive installations.'
  },
  {
    id: 'mb-winnipeg',
