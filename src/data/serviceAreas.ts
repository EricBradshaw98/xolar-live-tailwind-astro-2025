...
export const serviceAreas: ServiceArea[] = [
  {
    ...
    metaDescription:
      'Professional solar panel installation in Toronto, Ontario. Reduce energy costs with premium solar systems. Free quotes, 25-year warranty, certified installers.',
    keywords: [
    ...
    hero: {
      ...
      subtitle:
        'Join thousands of Toronto homeowners and businesses saving money with clean solar energy. Professional installation with 25-year warranty.',
    ...
    testimonials: [
      {
        ...
        location: 'North York',
        quote:
          'Our 8kW system has exceeded expectations. Living in Toronto, we were concerned about winter performance, but even on cloudy days we generate substantial power.',
        rating: 5,
      ...
      },
      {
        ...
        quote:
          'The installation team was professional and completed our roof-mounted system in one day. Our electricity bills have dropped by 85% since going solar.',
        rating: 5,
      ...
      },
      {
        ...
        location: 'Etobicoke',
        quote:
          'As a Toronto homeowner, I was impressed by how quickly we saw ROI. The system pays for itself while increasing our home value.',
        rating: 5,
...

  {
    ...
    metaDescription:
      'Expert solar panel installation in Vancouver, BC. Harness Pacific Northwest solar potential with premium systems. Free consultation and competitive pricing.',
    keywords: [
    ...
    hero: {
      ...
      subtitle:
        'Maximize your solar investment in Beautiful British Columbia. Professional installation designed for West Coast climate conditions.',
    ...
    testimonials: [
      {
        ...
        location: 'Kitsilano',
        quote:
          "Despite Vancouver's reputation for rain, our solar system produces excellent results. The summer months more than make up for winter production.",
        rating: 5,
      ...
      },
      {
        ...
        location: 'Richmond',
        quote:
          'Living near YVR, we wanted clean energy that made financial sense. Our system has exceeded all expectations for both savings and environmental impact.',
        rating: 5,
...

  {
    ...
    metaDescription:
      "Professional solar installation in Calgary, Alberta. Take advantage of Alberta's excellent solar potential and energy incentives. Expert installation team.",
    keywords: [
    ...
    hero: {
      ...
      subtitle:
        'Alberta leads Canada in solar potential. Join Calgary homeowners and businesses saving thousands with professional solar installations.',
    ...
    testimonials: [
      {
        ...
        location: 'Kensington',
        quote:
          "Calgary's sunshine makes solar incredibly effective. Our system generates more power than we use for 8 months of the year.",
        rating: 5,
      ...
      },
      {
        ...
        location: 'Airdrie',
        quote:
          'As Calgarians, we knew about our solar potential. The installation exceeded our expectations and the savings are substantial.',
        rating: 5,
...

  {
    ...
    metaDescription:
      'Professional solar panel installation in Mississauga, Ontario. Reduce energy costs with premium solar systems. Free quotes, 25-year warranty, certified installers.',
    keywords: [
    ...
    hero: {
      ...
      subtitle:
        'Join Mississauga homeowners and businesses saving money with clean solar energy. Professional installation with 25-year warranty.',
    ...
    testimonials: [
      {
        ...
        quote:
          'Our Mississauga home has been solar-powered for two years now. The savings are incredible and our system works perfectly through all seasons.',
        rating: 5,
      ...
      },
      {
        ...
        quote:
          'Living in Mississauga, we wanted the best solar system available. The installation was seamless and the results exceeded our expectations.',
        rating: 5,
...

  {
    ...
    metaDescription:
      "Professional solar installation in Edmonton, Alberta. Take advantage of Alberta's excellent solar potential and energy incentives. Expert installation team.",
    keywords: [
    ...
    hero: {
      ...
      subtitle:
        "Edmonton enjoys some of Canada's best solar conditions. Join homeowners and businesses across the capital region saving with solar energy.",
    ...
    testimonials: [
      {
        ...
        quote:
          "Edmonton's long summer days make our solar system incredibly productive. Even in winter, we generate substantial power and our bills are minimal.",
        rating: 5,
      ...
      },
      {
        ...
        location: 'St. Albert',
        quote:
          "As Edmonton residents, we knew about Alberta's solar potential. Our system has exceeded every expectation and the installation was flawless.",
        rating: 5,
...

  {
    ...
    metaDescription:
      "Professional solar panel installation in Ottawa, Ontario. Canada's capital city solar solutions. Reduce energy costs with premium solar systems.",
    keywords: [
      'solar panels Ottawa',
    ...
    hero: {
      ...
      subtitle:
        "Canada's capital embraces clean energy. Join Ottawa homeowners and businesses reducing costs with professional solar installation.",
    ...
    testimonials: [
      {
        ...
        location: 'Kanata',
        quote:
          'Our Ottawa home has been solar-powered for three years. The system works beautifully through our harsh winters and productive summers.',
        rating: 5,
      ...
      },
      {
        ...
        location: 'Orléans',
        quote:
          "En tant que résidents d'Ottawa, nous voulions la meilleure solution solaire. L'installation était parfaite et les économies sont excellentes.",
        rating: 5,
  ...
  // Quebec Service Areas
  {
    ...
    metaDescription:
      "Installation professionnelle de panneaux solaires à Montréal, Québec. Solutions d'énergie solaire pour résidentiel et commercial.",
    keywords: [
      'panneaux solaires Montréal',
      'énergie solaire Québec',
      'installation solaire Montréal',
    ],
...

  {
    ...
    metaDescription:
      'Installation professionnelle de panneaux solaires à Québec. Énergie renouvelable pour la capitale nationale.',
  ...
  // British Columbia Service Areas
  {
    ...
    metaDescription:
      'Professional solar installation in Victoria, BC. Island solar solutions with ocean views.',
...

  {
    ...
    metaDescription:
      'Expert solar panel installation in Burnaby, BC. Clean energy solutions for Metro Vancouver.',
  ...
  // Saskatchewan Service Areas
  {
    ...
    metaDescription:
      'Professional solar installation in Saskatoon, Saskatchewan. Prairie province solar solutions.',
...

  {
    ...
    metaDescription:
      'Expert solar panel installation in Regina, Saskatchewan. Capital city solar solutions.',
  ...
  // Manitoba Service Areas
  {
    ...
    metaDescription:
      'Professional solar installation in Winnipeg, Manitoba. Prairie province solar solutions.',
  ...
  // New Brunswick Service Areas
  {
    ...
    metaDescription:
      'Professional solar installation in Fredericton, New Brunswick. Maritime solar solutions.',
...

  {
    ...
    metaDescription:
      'Expert solar installation in Saint John, New Brunswick. Bay of Fundy solar solutions.',
  ...
  // Nova Scotia Service Areas
  {
    ...
    metaDescription:
      'Professional solar installation in Halifax, Nova Scotia. Atlantic Canada solar solutions.',
  ...
  // Prince Edward Island Service Areas
  {
    ...
    metaDescription:
      'Expert solar installation in Charlottetown, PEI. Island solar solutions for clean energy.',
  ...
  // Newfoundland and Labrador Service Areas
  {
    ...
    metaDescription:
      "Professional solar installation in St. John's, Newfoundland. Atlantic Canada's easternmost solar solutions.",
