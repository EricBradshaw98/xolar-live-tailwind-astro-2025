...
export const dealers: Dealer[] = [
  {
    ...
    description: 'Premier solar installation services across Ontario with over 10 years of experience.',
    metaDescription: 'Get a solar quote from Solar Solutions Ontario. Expert solar panel installation and maintenance services across Ontario.',
    ...
    hero: {
      ...
      subtitle: 'Transform your home or business with clean, renewable solar energy. Get a free consultation today.',
    ...
    formMessage: 'Ready to go solar? Fill out the form below and our Ontario solar experts will contact you within 24 hours with a personalized quote.'
  },
  
  {
    ...
    description: 'British Columbia\'s trusted solar energy partner specializing in eco-friendly solutions.',
    metaDescription: 'Solar installation services in BC from Green Energy BC. Sustainable solar solutions for homes and businesses.',
    ...
    hero: {
      ...
      subtitle: 'Harness the power of the sun with our sustainable solar solutions designed for British Columbia\'s unique climate.',
    ...
    formMessage: 'Join the renewable energy revolution in BC! Complete the form below and let\'s discuss how solar can benefit your property.'
  },
  
  {
    ...
    description: 'Alberta\'s leading solar installer with expertise in extreme weather installations.',
    metaDescription: 'Professional solar installation in Alberta. Prairie Solar Power - your trusted solar partner.',
    ...
    hero: {
      ...
      subtitle: 'Built tough for prairie conditions. Our solar systems are designed to withstand Alberta\'s challenging climate.',
    ...
    formMessage: 'Ready for prairie-tough solar? Our Alberta specialists are standing by to design your perfect system.'
  }
];
